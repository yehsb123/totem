...
const faqs: FAQItem[] = [
  {
    ...
    answer:
      "ToTem은 B2B SaaS 솔루션으로, 여행사나 가이드가 관광 코스를 효율적으로 기획하고 관리할 수 있도록 돕는 플랫폼입니다. 캘린더 일정 관리, 관광지 검색·코스 설계, 관광 데이터 대시보드, 리뷰 관리 등의 기능을 제공합니다.",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    answer:
      "ToTem은 사용자의 필요에 맞춰 다양한 요금제를 제공합니다. 자세한 요금 정보는 '요금제' 페이지에서 확인하실 수 있으며, 무료 체험으로 지금 제공되는 기능(Basic 요금제 기능)을 먼저 사용해 볼 수 있습니다. Pro 기능은 출시 후 안내합니다.",
  },
  {
    id: 4,
